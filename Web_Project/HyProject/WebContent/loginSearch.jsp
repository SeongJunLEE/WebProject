...
<head>
    <meta charset="utf-8">
    <title>SEARCHING THE POST</title>
...
<body>
    ...
    <div class="posts">
        <div class="row">
    		<c:forEach items="${photoSearch }" var="photosearch" varStatus="status">
    			<a href="postDetailServlet?p_id=${postSearch[status.index].p_id }">
				<div class ="post">
					<img src="uploadDirectory/${photosearch }"><br>
					<img id="likeImg"src="img/like.png">${postSearch[status.index].likes }<br>
					${postSearch[status.index].p_contents }
				</div>
				</a>
			</c:forEach>
        </div>
