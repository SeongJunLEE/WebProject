...
<body>
    ...
    <form action="" method="post" name="write" id ="inform" enctype="multipart/form-data">
    <div class="titbox">
      <div class="title">
        <span class="name">
        	게시물 작성</span>
    ...
    <div class="main">
      <div class="left">
        <img id="blah" src="img/white.png" alt="your image" width="300" height="460"><br>
        <input type="file" id ="imgInp" name="filename"><br>
      </div>
      <div class="right">
          <div>
            <br>글내용 <input type="text" id="p_contents" name="p_contents">
          </div>
        <div class="table1">
          <br><img src="img/top.png" id="top_color" width="150" height="150">
          <table>
            <tbody>
              <tr>
                ...
                <td><img class="topc" src="img/denim.png" alt="데님" width="20" name="color" value="denim"/></td>
                <td><img class="topc" src="img/purple.png" alt="보라" width="20" name="color" value="purple"/></td>
                <td><img class="topc" src="img/yellow.png" alt="노랑" width="20" name="color" value="yellow"/></td>
              </tr>
              <tr>
        ...
        <div class="table2">
          <br><img src="img/pants.png" id="bottom_color" width="150" height="150">
            <table>
              <tbody>
                  <tr>
        ...
        <div>
          <input id="button1" type="button" value="작성">
        </div>
      </div>
    </div>
  </form>
